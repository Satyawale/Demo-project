<?php
/*
Plugin Name: satyajeet wale
Version: 1.2.1
Plugin URI: https://satyawale.com
Author: naa986
Author URI: https://#
Description: use this plugin i made this for sedning mails using SMTP
...
class GMAIL_SMTP {
    ...
    function options_page() {
        ...
        $link_text = sprintf(wp_kses(__('Please visit the <a target="_blank" href="%s">Satyajeet wale</a> documentation page for usage instructions.', 'gmail-smtp'), array('a' => array('href' => array(), 'target' => array()))), esc_url($url));
        echo '<div class="wrap"><h2>Satyajeet v' . GMAIL_SMTP_VERSION . '</h2>';
